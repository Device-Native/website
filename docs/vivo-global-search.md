...
You can find the latest AAR hosted here: [https://dna-hosting.s3.amazonaws.com/public/com.devicenative.dna-vivo-v1.1.3.aar](https://dna-hosting.s3.amazonaws.com/public/com.devicenative.dna-vivo-v1.1.3.aar)
...
project-folder/libs/com.devicenative.dna-vivo-v1.1.3.aar
```
...
```gradle
dependencies {
    implementation files('libs/com.devicenative.dna-vivo-v1.1.3.aar')
}
```
